namespace Xilium.CefGlue.Demo
{
    ...
    public sealed class WebNavigationBox : Bin, IWebNavigationBox
    {
        ...
        public WebNavigationBox()
        {
            ...
            hbox.PackStart(_addressEntry, true, false, 0);
        ...
        protected override void OnGetPreferredHeight(out int minHeight, out int naturalHeight)
        {
            if (this.Child != null)
            {
                Child.GetPreferredHeight(out int min, out int natural);
                minHeight = min;
        ...
        protected override void OnGetPreferredWidth(out int minWidth, out int naturalWidth)
        {
            if (Child != null)
            {
                Child.GetPreferredWidth(out int min, out int natural);
                minWidth = min;
